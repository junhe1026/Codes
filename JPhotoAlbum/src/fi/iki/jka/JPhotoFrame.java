...
public class JPhotoFrame extends JFrame
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (cmd.equals(JPhotoMenu.A_NEW) || cmd.equals(JPhotoMenu.A_OPEN)) {
            ...
            JOptionPane.showMessageDialog(this, APP_NAME+" v1.4.5 - Organize and Publish Your Digital Photos.\n"+
                                          ...
                                          +" and Zbynekk [zbynek.muzik@email.cz]\n"
    ...
    private void preview() {
        ...
        preview.slideShow(this,photos,1000,list);
    }

    public void slideShow(int status) {
        if (status == 0){
            SlideShow show = new SlideShow();
            show.slideShow(this, photos, 5000, list);
        }
        else {
            JPhotoFrameTest fakeShow = new JPhotoFrameTest();
            fakeShow.slideShow(this, photos,5000,list);
        }
